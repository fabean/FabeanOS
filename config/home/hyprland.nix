...
let
  ...
  inherit (import ../../options.nix)
    browser cpuType gpuType wallpaperDir borderAnim theKBDLayout terminal
    theSecondKBDLayout theKBDVariant sdl-videodriver;
in with lib; {
  wayland.windowManager.hyprland = {
    ...
    in concatStrings [''
            ...
            monitor=eDP-1,highres,3441x1441,1
            monitor=DP-4,highres,0x1441,1
