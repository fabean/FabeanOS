  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      windowrulev2 = [
        ...
        "tag +terminal, class:^(Alacritty|kitty|kitty-dropterm|wezterm-dropterm)$"
        ...
        "tag +settings, class:^(nm-applet|nm-connection-editor|blueman-manager|blueberry)$"
        ...
        "float, class:^(kitty-memory-control)$"
        "float, class:^(kitty-cpu-control|kitty-volume-control)$"
        ...
        "size 50% 60%, class:^(kitty-memory-control)$"
        "size 50% 60%, class:^(kitty-cpu-control|kitty-volume-control)$"
